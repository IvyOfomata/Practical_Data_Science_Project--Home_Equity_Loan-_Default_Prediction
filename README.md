...
3. Model Selection & Tuning: Evaluating algorithms ranging from interpretable baseline models (Logistic Regression) to ensemble methods (Random Forest / XGBoost).
4. Evaluation: Assessing models using Precision, Recall, and ROC-AUC to balance credit risk detection with false rejection rates.
